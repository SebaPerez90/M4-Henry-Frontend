...
const Home = () => {
  return (
    <main className='relative h-[40em] w-full flex justify-center flex-col pepe after:absolute after:w-full after:h-[40em] after:bg-[#000000d4] after:-z-10 z-10'>
      <Image
        className='absolute top-0 z-10 h-[40em] object-cover opacity-45'
        src={hero_img}
        alt='background img'
      />
      <header className='z-20 gap-3 flex justify-center items-center flex-col'>
        ...
        <button className='p-4 rounded-xl bg-slate-50 font-semibold'>submit btn</button>
      </header>
    </main>
  );
};
